...
document.getElementById("Tt").innerText = m + " مليون و" +m2  + "  الف "  ;
  ...
  if(Tkh35<999){
   ...
   /*var Ss1 = document.gerElementById("T16").value;
   var Ss2 = document.gerElementById("T15").value;
   var Ss3 = document.gerElementById("T14").value;
   var Ss4 = document.gerElementById("T20").value;
   var Ss5 = document.gerElementById("T19").value;

   if(Ss1<999){
    document.getElementById("T16").innerText = Ss1 + "  مليون " ;
   }

   if(Ss1>999){
   var ss1 = Ss1 / 1000 ;
   var ss1 = Math.trunc(ss1);
   ...
   document.getElementById("T16").innerText = ss1 + " مليار و " + SS1 + "  مليون "   ;
   } */
